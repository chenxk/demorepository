...
public class MyEclipseGen {
	...
	private static final String LL = "Decompiling this copyrighted software is a violation of "
			...
			+ "(http://www.loc.gov/copyright/legislation/dmca.pdf). Under section 1204 of the "
			+ "DMCA, penalties range up to a $500,000 fine or up to five years imprisonment for "
			+ "a first offense. Think about it; pay for a license, avoid prosecution, "
